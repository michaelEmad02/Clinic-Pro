...
class SocialLoginButton extends StatelessWidget {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: type == SocialLoginType.google ? AppColors.surfaceContainerLow : AppColors.surface,
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: type == SocialLoginType.google ? Colors.transparent : AppColors.border,
          ),
        ),
        child: Row(
  ...
  Widget _buildIcon() {
    if (type == SocialLoginType.google) {
      ...
      return const Icon(Icons.apple, size: 24, color: AppColors.textPrimary);
    }
  }
}
