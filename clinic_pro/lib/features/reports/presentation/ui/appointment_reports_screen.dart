...
class AppointmentReportsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (_) => sl<AppointmentReportsCubit>()..loadReports(doctorId: doctorId),
        ),
        BlocProvider(
...
class _AppointmentReportsBody extends StatelessWidget {
  final String? doctorId;
      ...
      body: BlocBuilder<AppointmentReportsCubit, AppointmentReportsState>(
        builder: (context, reportsState) {
          ...
          if (reportsState is AppointmentReportsError) {
            if (reportsState.failure is FeatureNotAllowedFailure) {
              final fail = reportsState.failure as FeatureNotAllowedFailure;
              return FeatureLockedPaywallWidget(
                featureName: AppStrings.isArabic ? 'تقارير المواعيد' : 'Appointment Reports',
                    ...
                    children: [
                      ...
                      ReportsDateRangeChips(
                        ...
                        onChanged: (range) {
                          context
                              .read<AppointmentReportsCubit>()
                              .changeRange(range, doctorId: doctorId);
                        },
